...
<head>
    ...
    {{-- slider --}}
    <link href="{{ asset('backend/swiper-bundle.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('backend/swiper-bundle.min.js') }}" rel="stylesheet" />
    <link href="{{ asset('backend/swiper.js') }}" rel="stylesheet" />
